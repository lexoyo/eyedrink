...
SET input_files_path=../assets/icons ../assets/splashScreens ../assets/icons/icon_114.png ../assets/splashScreens/Default.png config.xml index.html ../../../bin/eyedrink.js ../../../bin/app.css ../../../bin/assets
